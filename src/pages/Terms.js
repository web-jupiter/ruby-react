...
export class Terms extends React.Component {
    ...
    componentDidMount() {
        document.title = 'WeRate - Terms of Use';
    }
                        ...
                        <div className="col-md-9">
                            <div className="terms-list">
                                <div className="terms-item">
                                    <p>These user terms and conditions (hereinafter referred to as the {'"'}User Terms{'"'}) apply to any use of Werate{"'"}s website (hereinafter referred to as the {'"'}Website{'"'}), including - but not limited to - www.Werate.co.</p>
                                    <p>In these User Terms, the words "we", "us" and "ours" refer to Werate.</p>
                                ...
                                <div className="terms-item">
                                    <label><b>THE SERVICES ON THE WEBSITE</b></label>
                                    <h5 className="terms-subtitle">1  Registered User</h5>
                                    <p>1.1  Werate grants you the non-exclusive, non-transferable, revocable, limited right to access and use the Website. In order to gain full access and use of the Website, you must create a profile and register as a user (hereinafter referred to as "Registered User").</p>
                                    ...
                                    <p>1.7  Furthermore, we reserve the right, at any time and without notice or explanation, to delete your profile and user-generated content (see 2.1). In this case, our disclaimer applies without limitations.</p>
                                    ...
                                    <h5 className="terms-subtitle">2  User-Generated Content from Registered Users</h5>
                                    ...
                                    <p>2.2  Registered Users are liable for the UGC they publish on the Website.</p>
                                    <p>2.3  Registered Users warrant that all UGC posted on the Website is correct and true (where they state facts) or genuinely held (where they state opinions).</p>
                                    <p>2.4  UGC must relate to a company or organization from which the Registered User has purchased or can otherwise document using the company's or organization's products or services.</p>
                                    <p>2.5  You may not publish UGC regarding companies to which you have personal or professional relations.</p>
                                    <p>2.6  Registered Users must not, and must not allow any third party to, publish UGC on the website which</p>
                                    <ul>
                                        <li>is of a marketing nature or has marketing purposes,</li>
                                        <li>is unlawful, deceptive, misleading, fraudulent, threatening, abusive, harassing, libelous, defamatory, tortious, obscene, pornographic or profane,</li>
                                        <li>has sexist, political or racial character,</li>
                                        <li>violates other people{"'"}s rights, including any intellectual property rights, rights of privacy and/or rights of publicity,</li>
                                        <li>is offensive or in any way breaches any applicable local, national or international law or regulation,</li>
                                        <li>violates these User Terms, including the User Guidelines,</li>
                                        <li>reveals any personal information about another individual, including another person{"'"}s name, address, phone number, email address, credit card information or any other information that could be used to track, contact or impersonate that person,</li>
                                ...
                                <div className="terms-item">
                                    <label><b>GENERAL TERMS</b></label>
                                    <h5 className="terms-subtitle">3  Rights</h5>
                                    ...
                                    <p>3.2  The content on the Website, including but not limited to the intellectual property rights, text, characteristics, graphics, icons, photos, calculations, references and software is or will be our property or the property of a third party (other than the Registered User) and is protected by U.S. and applicable international legislation, including without limitation applicable copyright and trademark laws.</p>
                                    <p>3.3  Unauthorized copying, distribution, presentation or other use of the Website or part hereof is a violation of Hong Kong SAR law and may thus result in civil and/or criminal penalties.</p>
                                    <p>3.4  To the fullest extent permitted by law, the rights to free use of the UGC are transferred to us irrevocably, without any time limitation and without territorial limitations, by submitting the UGC to us.</p>
                                    ...
                                    <p>3.6  All company names, trademarks and other business characteristics on the Website is or will be our property or the property of a third party (other than the Registered User) and must only be used for business purposes upon prior approval from us or the third party owner, respectively.</p>
                                    <h5 className="terms-subtitle">4  Personal data</h5>
                                    <p>4.1  We perform different types of processing of personal data in connection with the use of the Website. Our processing of personal data takes place under observance of our Privacy Policy. By accepting these User Terms, you confirm to have read and accepted our Privacy Policy.</p>
                                    <h5 className="terms-subtitle">5  Disclaimers</h5>
                                    <p>5.1  THE WEBSITE, CONTENT AND SERVICES OFFERED ON THE WEBSITE ARE PROVIDED 'AS IS' AND AS AVAILABLE WITHOUT REPRESENTATIONS OR WARRANTIES OF ANY KIND. WERATE EXPRESSLY DISCLAIMS ANY AND ALL WARRANTIES, EXPRESS, IMPLIED OR STATUTORY, INCLUDING WITHOUT LIMITATION ANY WARRANTIES OF NON-INFRINGEMENT, MERCHANTABILITY OR FITNESS FOR A PARTICULAR PURPOSE. THE WEBSITE AND SERVICES MAY BE MODIFIED, UPDATED, INTERRUPTED, SUSPENDED OR DISCONTINUED AT ANY TIME WITHOUT NOTICE OR LIABILITY.</p>
                                    <p>5.2  We make no representations or warranties with respect to any UGC published on the Website. Notwithstanding the foregoing, Werate may at all times investigate and edit (including anonymizing) UGC, e.g. if such actions are (i) prompted by third party requests, (ii) required under applicable law or (iii) necessary for the UGC"'"s compliance with our User Guidelines.</p>
                                    <p>5.3  We disclaim all liability for the content of UGC. Our non-liability applies, without limitation, to any UGC, including UGC which has been edited by us (see 5.2). We are not liable for any links to third party websites in the UGC, including for the content of the page to which the UGC links.</p>
                                    ...
                                    <h5 className="terms-subtitle">6  Limitation of liability</h5>
                                    ...
                                    <h5 className="terms-subtitle">7  Other User Terms</h5>
                                    ...
                                    <h5 className="terms-subtitle">8  Term and termination</h5>
                                    ...
                                    <h5 className="terms-subtitle">9  Applicable law and venue</h5>
                                    <p>9.1  The User Terms and the relationship between you and Werate are governed by the laws of the State of New York, without regard to the conflicts of law provisions thereof. Any disputes must be brought exclusively in the state or federal courts located in New York, and the parties hereby consent to the jurisdiction of such courts.</p>
                                    <h5 className="terms-subtitle">10  Copyright dispute policy</h5>
                                    <p>10.1 It is Werate"'"s policy to (i) block access to or remove material that it believes in good faith to be copyrighted material that has been illegally copied and distributed by any of our advertisers, affiliates, content providers or members or users; and (ii) remove and discontinue service to repeat offenders.</p>
                                    <h5 className="terms-subtitle">11  Miscellaneous</h5>
                                    <p>11.1  You acknowledge and agree that these User Terms constitute the complete and exclusive agreement between you and Werate concerning your use of the Website and supersede and govern all prior proposals, agreements or other communications.</p>
                                    <p>11.2  Nothing contained in these User Terms can be construed as creating any agency, partnership or other form of joint enterprise between us. Our failure to require your performance of any provision hereof will not affect our full right to require such performance at any time thereafter, nor may our waiver of a breach of any provision hereof be taken or held to be a waiver of the provision itself. You may not assign any rights granted to you hereunder, and any such attempts are void.</p>
                                    <h5 className="terms-subtitle">12  CONTACT</h5>
                                    <p>12.1  You may contact Werate via email at hello@Werate.co</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-3">
                            <label className="label-description-title">WeRate</label>
                            <p className="label-description-description">
                                10/F, The Wave, 4 Hing Yip Street, Kwun Tong, Hong Kong
                            </p>
                            <label className="label-description-email">hello@werate.co</label>
                        </div>
                    </div>
                </div>
            </div>
