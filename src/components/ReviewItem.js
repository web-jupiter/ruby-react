...
export class ReviewItem extends React.Component {
    ...
    delete(id) {
        ...
        fetch(Common.BACKEND + '/review/delete?id=' + id, {
            method: 'GET',
        })
    ...
    approveDismiss(id, flag) {
        ...
        fetch(Common.BACKEND + '/review/approveDismiss?id=' + id + '&flag=' + flag, {
            method: 'GET',
        })
            .then(results => results.json())
            .then(data => {
                        ...
                        <div className="col-md-9">
                            <h4 className="review-title">
                                ...
                                {review.attachment != null ?
                                    <a href={Common.BACKEND + '/' + review.attachment.path} className="attachment-link">{review.attachment.file_name}</a>
                                    : null}
